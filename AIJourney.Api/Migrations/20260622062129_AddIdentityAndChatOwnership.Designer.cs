...
namespace AIJourney.Api.Migrations
{
    ...
    [Migration("20260622062129_AddIdentityAndChatOwnership")]
    partial class AddIdentityAndChatOwnership
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIJourney.Api.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AIJourney.Api.Models.Chat", b =>
                {
                    b.HasOne("AIJourney.Api.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AIJourney.Api.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
